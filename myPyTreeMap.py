...
def drawTreeMap(myCanvas, pos, rectangles, sliver=1, colorSeed="#7F7F7F"):
...
#         box = box[ [1,0,3,2] ]
    ...
    x0,y0,xn,yn = pos
    x0,y0,xn,yn = x0+sliver, y0+sliver, xn-sliver, yn-sliver
...
for index,box in enumerate(masterLayout):
    drawTreeMap(myCanvas, corners(box), sublayouts[index], colorSeed=color(), sliver=1)
